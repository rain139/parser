...
__all__ = ['vcs', 'get_parser_requirement']
...
class VersionControl(object):
    ...
    def get_parser_requirement(self, dist, location):
        """
...
def get_parser_requirement(dist, location):
    version_control = vcs.get_backend_from_location(location)
    if version_control:
        try:
            return version_control().get_parser_requirement(dist,
                                                         location)
        except BadCommand:
            logger.warning(
